...
Description:
Creates a table of all Covid+ patients based off any of the following conditions or measurements:
    1. Positive PCR or Antigen Test **ONLY** [THIS IS THE DEFAULT SETTING]         
OR    
    1. Positive PCR or Antigen Test
    2. Positive Antibody Test
    3. Covid Diagnosis

To switch between the above:
When set to True, the boolean value USE_POSLAB_ONLY will insure that only 
positive PCR and Antigen will be saved as indicators of COVID infection
